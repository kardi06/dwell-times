...
export const GlobalFilterBar: React.FC = () => {
  ...
  const selectedDepartment = draft.department
    ...
    : null;
  const selectedStore = draft.store
    ? { value: draft.store, label: draft.store }
    : null;
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap gap-3 items-end">
        ...
        <div className="flex flex-col">
          ...
          <select
            ...
            onChange={(e) =>
              setDraft({ timePeriod: e.target.value as TimePeriod })
            }
            ...
            <DatePicker
              ...
              dateFormat={
                draft.timePeriod === "day"
                  ? "yyyy-MM-dd"
                  : draft.timePeriod === "month" ||
                      draft.timePeriod === "quarter"
                    ? "yyyy-MM"
        ...
        <div className="ml-auto flex gap-2">
          ...
          <button
            className="px-4 py-2 bg-white text-red-800 font-medium rounded hover:bg-red-50"
            onClick={apply}
          >
            Apply
          </button>
          <button
            className="px-4 py-2 border border-white/70 text-white rounded hover:bg-white/10"
            onClick={reset}
          >
            Reset
          </button>
